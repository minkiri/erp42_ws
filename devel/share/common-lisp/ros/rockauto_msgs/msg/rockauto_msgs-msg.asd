...
(defsystem "rockauto_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "gridmap_point" :depends-on ("_package_gridmap_point"))
    (:file "_package_gridmap_point" :depends-on ("_package"))
    (:file "trackingdetection" :depends-on ("_package_trackingdetection"))
    (:file "_package_trackingdetection" :depends-on ("_package"))
  ))