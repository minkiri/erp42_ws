...
class DetectedObject {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('gridmappoint')) {
        this.gridmappoint = initObj.gridmappoint
      }
      else {
        this.gridmappoint = [];
      }
      ...
      if (initObj.hasOwnProperty('mean_point')) {
        this.mean_point = initObj.mean_point
      }
      else {
        this.mean_point = new geometry_msgs.msg.Pose();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [gridmappoint]
    // Serialize the length for message field [gridmappoint]
    bufferOffset = _serializer.uint32(obj.gridmappoint.length, buffer, bufferOffset);
    obj.gridmappoint.forEach((val) => {
      bufferOffset = gridmap_point.serialize(val, buffer, bufferOffset);
    });
    ...
    // Serialize message field [mean_point]
    bufferOffset = geometry_msgs.msg.Pose.serialize(obj.mean_point, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [gridmappoint]
    // Deserialize array length for message field [gridmappoint]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.gridmappoint = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.gridmappoint[i] = gridmap_point.deserialize(buffer, bufferOffset)
    }
    ...
    // Deserialize message field [mean_point]
    data.mean_point = geometry_msgs.msg.Pose.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.gridmappoint.length;
  ...
  static md5sum() {
    ...
    return '53f4f934056941541513978ff750e252';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.gridmappoint !== undefined) {
      resolved.gridmappoint = new Array(msg.gridmappoint.length);
      for (let i = 0; i < resolved.gridmappoint.length; ++i) {
        resolved.gridmappoint[i] = gridmap_point.Resolve(msg.gridmappoint[i]);
      }
    }
    else {
      resolved.gridmappoint = []
    }
    ...
    if (msg.mean_point !== undefined) {
      resolved.mean_point = geometry_msgs.msg.Pose.Resolve(msg.mean_point)
    }
    else {
      resolved.mean_point = new geometry_msgs.msg.Pose()
    }
