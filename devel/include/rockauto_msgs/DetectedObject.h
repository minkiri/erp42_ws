...
#include <sensor_msgs/PointCloud2.h>
#include <rockauto_msgs/gridmap_point.h>
...
struct DetectedObject_
{
  ...
  _worldpointcloud_type worldpointcloud;
   ...
   typedef std::vector< ::rockauto_msgs::gridmap_point_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rockauto_msgs::gridmap_point_<ContainerAllocator> >> _gridmappoint_type;
  _gridmappoint_type gridmappoint;
  ...
  _user_defined_info_type user_defined_info;
   ...
   typedef  ::geometry_msgs::Pose_<ContainerAllocator>  _mean_point_type;
  _mean_point_type mean_point;
...
bool operator==(const ::rockauto_msgs::DetectedObject_<ContainerAllocator1> & lhs, const ::rockauto_msgs::DetectedObject_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.gridmappoint == rhs.gridmappoint &&
...
struct MD5Sum< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x53f4f93405694154ULL;
  static const uint64_t static_value2 = 0x1513978ff750e252ULL;
};
...
struct Printer< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rockauto_msgs::DetectedObject_<ContainerAllocator>& v)
  {
    ...
    s << indent << "gridmappoint[]" << std::endl;
    for (size_t i = 0; i < v.gridmappoint.size(); ++i)
    {
      s << indent << "  gridmappoint[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::rockauto_msgs::gridmap_point_<ContainerAllocator> >::stream(s, indent + "    ", v.gridmappoint[i]);
    }
    ...
    s << indent << "mean_point: ";
    s << std::endl;
    Printer< ::geometry_msgs::Pose_<ContainerAllocator> >::stream(s, indent + "  ", v.mean_point);
    s << indent << "distance: ";
