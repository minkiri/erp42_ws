...
class DetectedObject(genpy.Message):
  _md5sum = "53f4f934056941541513978ff750e252"
...
"""
  __slots__ = ['header','id','label','score','color','valid','space_frame','pose','dimensions','variance','velocity','acceleration','pointcloud','worldpointcloud','gridmappoint','convex_hull','candidate_trajectories','pose_reliable','velocity_reliable','acceleration_reliable','image_frame','x','y','width','height','angle','roi_image','indicator_state','behavior_state','user_defined_info','mean_point','distance','world_velocity','local_velocity','theta','world_point','yaw','yaw_rate']
  _slot_types = ['std_msgs/Header','uint32','string','float32','std_msgs/ColorRGBA','bool','string','geometry_msgs/Pose','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Twist','geometry_msgs/Twist','sensor_msgs/PointCloud2','sensor_msgs/PointCloud2','rockauto_msgs/gridmap_point[]','geometry_msgs/PolygonStamped','rockauto_msgs/LaneArray','bool','bool','bool','string','int32','int32','int32','int32','float32','sensor_msgs/Image','uint8','uint8','string[]','geometry_msgs/Pose','float32','float32','float32','float32','geometry_msgs/Pose','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,label,score,color,valid,space_frame,pose,dimensions,variance,velocity,acceleration,pointcloud,worldpointcloud,gridmappoint,convex_hull,candidate_trajectories,pose_reliable,velocity_reliable,acceleration_reliable,image_frame,x,y,width,height,angle,roi_image,indicator_state,behavior_state,user_defined_info,mean_point,distance,world_velocity,local_velocity,theta,world_point,yaw,yaw_rate
    ...
    if args or kwds:
      ...
      if self.mean_point is None:
        self.mean_point = geometry_msgs.msg.Pose()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.worldpointcloud.is_dense
      buff.write(_get_struct_B().pack(_x))
      length = len(self.gridmappoint)
      buff.write(_struct_I.pack(length))
      for val1 in self.gridmappoint:
        _x = val1
      ...
      _x = self
      buff.write(_get_struct_7d4f7d2f().pack(_x.mean_point.position.x, _x.mean_point.position.y, _x.mean_point.position.z, _x.mean_point.orientation.x, _x.mean_point.orientation.y, _x.mean_point.orientation.z, _x.mean_point.orientation.w, _x.distance, _x.world_velocity, _x.local_velocity, _x.theta, _x.world_point.position.x, _x.world_point.position.y, _x.world_point.position.z, _x.world_point.orientation.x, _x.world_point.orientation.y, _x.world_point.orientation.z, _x.world_point.orientation.w, _x.yaw, _x.yaw_rate))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.worldpointcloud.is_dense,) = _get_struct_B().unpack(str[start:end])
      ...
      self.gridmappoint = []
      for i in range(0, length):
        val1 = rockauto_msgs.msg.gridmap_point()
        _x = val1
        start = end
        end += 8
        (_x.x, _x.y,) = _get_struct_2f().unpack(str[start:end])
        self.gridmappoint.append(val1)
      _x = self
      start = end
      end += 12
      ...
      (_x.mean_point.position.x, _x.mean_point.position.y, _x.mean_point.position.z, _x.mean_point.orientation.x, _x.mean_point.orientation.y, _x.mean_point.orientation.z, _x.mean_point.orientation.w, _x.distance, _x.world_velocity, _x.local_velocity, _x.theta, _x.world_point.position.x, _x.world_point.position.y, _x.world_point.position.z, _x.world_point.orientation.x, _x.world_point.orientation.y, _x.world_point.orientation.z, _x.world_point.orientation.w, _x.yaw, _x.yaw_rate,) = _get_struct_7d4f7d2f().unpack(str[start:end])
      return self
...
def _get_struct_5fB():
    ...
    return _struct_5fB
_struct_7d4f7d2f = None
def _get_struct_7d4f7d2f():
    global _struct_7d4f7d2f
    if _struct_7d4f7d2f is None:
        _struct_7d4f7d2f = struct.Struct("<7d4f7d2f")
    return _struct_7d4f7d2f
_struct_8d = None
def _get_struct_8d():
    global _struct_8d
